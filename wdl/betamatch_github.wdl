task match_betas{
    ...
    command <<<
        ...
        corrplot.py ${out_f} --fields unif_beta_fg unif_beta_ext --se-fields se_ext se_fg --x-title "FinnGen beta" --y-title "External beta" --pval_field pval_ext --pval_threshold ${pval_threshold} --out "output.pdf"
    >>>
